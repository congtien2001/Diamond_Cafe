						...
						<ul class="dropdown-menu">
							...
							<img src="./Themes/dist/img/user2-160x160.jpg"
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="./Quanlyhethong/xemthongtinadmin.jsp" class="btn btn-default btn-flat">Tài khoản</a>
									</div>
									<div class="pull-right">
										<a href="./Quanlyhethong/dangnhap.jsp" class="btn btn-default btn-flat">Đăng xuất</a>
									</div>
								</li>
							</ul>
						</li>
...
<!-- QUAN LY MON -->
        <li class="active">
          <a href="./Quanlymon/hienthidanhsach.jsp">          
...
<!-- QUAN LY LOAI MON -->
        <li class="active">
          <a href="./Quanlyloaimon/hienthiLM.jsp">
...
<!-- QUAN LY KHACH HANG -->
        <li class="active">
          <a href="./Quanlykhachhang/hienthiKH.jsp">
...
<!-- QUAN LY NHAN VIEN -->
        <li class="active">
          <a href="./Quanlynhanvien/hienthiNV.jsp">
...
<!-- THONG KE DOANH THU -->
        <li class="active">
          <a href="./Thongkethuchi/thongke.jsp">
    ...
    <!-- /.sidebar -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h2 style="color: dodgerblue; font-family: fantasy; ">Website Administrator</h2>
				<h1 style="color: dodgerblue;">Welcome Admin</h1>
</section>

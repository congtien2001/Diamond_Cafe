					...
					<div class="box-body">
						<form class="form-horizontal" action="/Customer/Save"
							...
							<div class="form-group">
								<label class="control-label col-sm-2">Nhập mật khẩu:</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="control-label col-sm-2">Nhập mật khẩu mới:</label>
								<div class="col-sm-10">
									<input autofocus="autofocus" class="form-control"
										id="CustomerName" name="CustomerName" type="text" value="" />
									<span class="field-validation-valid"
							...
							<div class="form-group">
								<label class="control-label col-sm-2">Xác nhận lại mật khẩu mới:</label>
								<div class="col-sm-10">
									<input autofocus="autofocus" class="form-control"
										id="CustomerName" name="CustomerName" type="text" value="" />
									<span class="field-validation-valid"

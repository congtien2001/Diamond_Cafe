    ...
    <!-- /.sidebar -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1 style="font-size: 40px";>XÓA MÓN</h1>
        ...
        <form role="form">
          <div class="box-body">                              
			...
			<div class="form-group">
				<label class="control-label col-sm-2">Mã món:</label>
                <p class="form-control-static">Cà phê đen</p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="form-control-static">Cà phê Việt Nam</p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="form-control-static">1 Ly</p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="form-control-static">12,000 VDN</p>
            </div>
							...
							<div class="form-group" style="text-align: end">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-primary" style="background-color: red">
										<i class="glyphicon glyphicon-floppy-disk"></i> Xoá
									</button>
